...
export function useFormState(): FormState {
  ...
  return {
    ...
    setLocation: (value) => dispatch({ type: "SET_STRING_FIELD", field: "location", value }),
    setUsers: (value) => dispatch({ type: "SET_STRING_FIELD", field: "users", value }),
    setGroups: (value) => dispatch({ type: "SET_STRING_FIELD", field: "groups", value }),
    setFolders: (value) => dispatch({ type: "SET_STRING_FIELD", field: "folders", value }),
